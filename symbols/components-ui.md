...
| `Textarea` | textarea.tsx | **Unused, and carries a known bug** — see LESSONS.md Lesson 001 / TECH_DEBT TD-004 (`field-sizing-content` jumping-textarea issue). |
...
- `Textarea` — see TD-004, Lesson 001.
